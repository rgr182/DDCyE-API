...
#pragma warning restore OPENAI001
        ...
        public async Task SubmitToolOutputsToRunAsync(string threadId, string runId, IEnumerable<ToolOutput> toolOutputs)
        {
#pragma warning disable OPENAI001
            _logger.LogInformation("Submitting batch tool outputs to run: {ThreadID}, {RunID}, {Count} outputs",
                threadId, runId, toolOutputs.Count());
